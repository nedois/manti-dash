...
export function varBgColor(colors: Array<string>, options?: TargetAndTransition): Variants {
  return {
    animate: {
      background: colors,
      ...options,
...
export function varBgKenburns(direction: Direction, options?: TargetAndTransition): Variants {
...
export function varBgPan(direction: Direction, colors: Array<string>, options?: TargetAndTransition): Variants {
